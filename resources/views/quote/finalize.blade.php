    ...
    <div class="flex justify-center">
        <div class="w-8/12">
            ...
            <div class="flex justify-center mt-5 mb-5 space-x-2 text-center">
                ...
                <form action="{{ route('quotes.create.email', $quote) }}" method="GET">
                    @csrf
                    <button
                        class="bg-indigo-500 hover:bg-indigo-700 transition-colors duration-200 text-white font-bold py-2 px-4 rounded-lg"
                        type="submit">
            ...
            <div class="p-6 text-gray-700">
                ...
                <div class="flex flex-wrap mb-2">
                    ...
                    <div class="w-2/3">
                        <input readonly
                            class="shadow appearance-none border rounded w-full p-3 text-gray-700 leading-none focus:outline-none focus:shadow-outline"
                            name="date" type="text" value="{{ $quote->quote_date }}">
                    </div>
                </div>
                ...
                <div class="flex flex-wrap mb-2">
                    ...
                    <div class="w-2/3">
                        <input readonly
                            class="shadow appearance-none border rounded w-full p-3 text-gray-700 leading-none focus:outline-none focus:shadow-outline"
                            name="sender" type="text" value="{{ $sender }}">
                    </div>
                </div>
                ...
                <div class="flex flex-wrap mb-2">
                    ...
                    <div class="w-2/3">
                        <input readonly
                            class="shadow appearance-none border rounded w-full p-3 text-gray-700 leading-none focus:outline-none focus:shadow-outline"
                            name="receiver" type="text" value="{{ $client }}">
                    </div>
                </div>
            </div>
        </div>
